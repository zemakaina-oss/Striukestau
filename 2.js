...
const PRODUCTS = [
  ...
  },
  {
    ...
    colors: ['Tamsiai mėlyna', 'Tamsiai chaki'],
    tiers: [{min:5,max:10,price:65},{min:11,max:20,price:45},{min:21,max:null,price:42}],
    desc: 'Vidutinio ilgio, pilnai šilta žieminė striukė su reguliuojamu gobtuvu. Puikiai tinka tiek kasdieniam nešiojimui, tiek reprezentacinei aprangai. Prieinama dviem spalvomis.'
  },
  {
    id: 'p06',
