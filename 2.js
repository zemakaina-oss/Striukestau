...
const PRODUCTS = [
  ...
  },
  {
    ...
    desc: 'Ilgas žieminis paltas (dengia iki kelių) su kupranugario vilnos užpildu ir nusegamu natūraliu kailiuku ant gobtuvo. Prieinamas chaki ir juoda spalvomis. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p07',
    name: 'Ilga žieminė striukė',
    season: 'ziema',
    ...
    desc: 'Ilga (dengia iki šlaunų), pilnai šilta žieminė striukė su gobtuvu, juoda spalva. Skirta komandoms, dirbančioms lauke ilgesnį laiką. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p02',
    name: 'Ilga parka',
    ...
    desc: 'Ilgesnio kirpimo, juodos spalvos parka (dengia iki šlaunų) su kupranugario vilnos užpildu, skirta reprezentacinėms pareigoms lauke. Puikiai tinka klientų aptarnavimo ir vadovų komandoms. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p13',
    name: 'Ilga parka su gobtuvu',
    season: 'ziema',
    ...
    desc: 'Ilgesnio kirpimo žieminė parka (dengia iki kelių) su reguliuojamu gobtuvu, grafito pilkos spalvos. Solidus, santūrus modelis. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p12',
    ...
    colors: ['Tamsiai mėlyna', 'Tamsiai chaki'],
    tiers: [{min:5,max:10,price:65},{min:11,max:20,price:45},{min:21,max:null,price:42}],
    desc: 'Vidutinio ilgio, pilnai šilta žieminė striukė su reguliuojamu gobtuvu. Puikiai tinka tiek kasdieniam nešiojimui, tiek reprezentacinei aprangai. Prieinama dviem spalvomis. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p06',
    ...
    desc: 'Tas pats įprasto ilgio modelis šviesesne, kupranugario spalva. Reguliuojamas gobtuvas, kelios kišenės. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p04',
  ...
  {
    id: 'p09',
    name: 'Bomber tipo striukė',
    season: 'pavasaris-ruduo',
    images: ['jacket-35.jpg','jacket-36.jpg'],
    tiers: [{min:5,max:10,price:40},{min:11,max:20,price:28},{min:21,max:null,price:26}],
    desc: 'Trumpo, sportiško kirpimo bomber tipo striukė (iki juosmens), tamsiai mėlynos spalvos. Tinka laisvalaikio ir kasdienei komandos aprangai. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p08',
    ...
    desc: 'Trumpesnio kirpimo striukė (iki klubų) su gobtuvu. Tinka kasdieniam biuro ir lauko naudojimui. Prieinama dviem spalvomis. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p05',
    name: 'Sportinė striukė',
    ...
    tiers: [{min:5,max:10,price:50},{min:11,max:20,price:35},{min:21,max:null,price:32}],
    desc: 'Įprasto ilgio, tamsiai mėlynos spalvos striukė su reguliuojamu gobtuvu. Universalus modelis pereinamajam sezonui. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p14',
    name: 'Sportinė striukė',
  ...
  {
    id: 'p11',
    name: 'Vidutinio ilgio striukė',
    season: 'pavasaris-ruduo',
    images: ['jacket-43.jpg','jacket-44.jpg','jacket-46.jpg','jacket-47.jpg','jacket-48.jpg','jacket-49.jpg'],
    colors: ['Chaki', 'Mėlyna'],
    tiers: [{min:5,max:10,price:45},{min:11,max:20,price:31},{min:21,max:null,price:29}],
    desc: 'Vidutinio ilgio striukė (dengia klubus) su reguliuojamu gobtuvu ir keliomis kišenėmis, chaki / mėlynos spalvos. Modelis nuotraukoje 197 cm ūgio.'
  },
  {
    id: 'p10',
    name: 'Vidutinio ilgio striukė',
    ...
    tiers: [{min:5,max:10,price:45},{min:11,max:20,price:31},{min:21,max:null,price:29}],
    desc: 'Vidutinio ilgio striukė (dengia klubus) su reguliuojamu gobtuvu, tamsiai žalios spalvos. Modelis nuotraukoje 197 cm ūgio.'
  }
];
