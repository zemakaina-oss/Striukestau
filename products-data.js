/* ============================================
   ...
   Kiekvienam produktui: id, pavadinimas, sezonas,
   kainų pakopos (5-15 / 16-50 / 51+ vnt.), aprašymas, nuotraukos.
   Sugrupuota pagal realius modelius (patvirtinta kliento).
   KAINOS — PRELIMINARIOS, laukiama realių.
   ============================================ */
...
const PRODUCTS = [
  {
    id: 'p01',
    name: 'Striukė su kupranugario užpildu, juoda',
    season: 'ziema',
    ...
    desc: 'Šilta, įprasto ilgio striukė su kupranugario vilnos užpildu, juoda spalva. Tinka tiek prie švarko, tiek prie džinsų — universalus pasirinkimas komandos aprangai.'
  },
  {
    id: 'p03',
  ...
  },
  {
    ...
    tiers: [{min:5,max:10,price:65},{min:11,max:20,price:45},{min:21,max:null,price:42}],
    desc: 'Vidutinio ilgio, pilnai šilta žieminė striukė su reguliuojamu gobtuvu ir ryškiu vidiniu pamušalu.'
  },
  {
    id: 'p06',
  ...
  },
  {
    ...
    sizes: ['48','50','52','54','56','58','60','62','64','66','68','70'],
    tiers: [{min:5,max:10,price:50},{min:11,max:20,price:35},{min:21,max:null,price:32}],
    desc: 'Ilgesnio kirpimo striukė su reguliuojamu gobtuvu ir krūtinės kišene — dengia klubus, todėl patogiai tinka dėvėti ir virš švarko. Modelis nuotraukoje 197 cm ūgio. Prieinama keliomis spalvomis.'
  },
  {
    id: 'p09',
  ...
  {
    id: 'p08',
    name: 'Trumpa rudeninė striukė, chaki',
    season: 'pavasaris-ruduo',
    ...
    desc: 'Trumpesnio kirpimo striukė (iki klubų) su gobtuvu, chaki spalva. Tinka kasdieniam biuro ir lauko naudojimui.'
  },
  {
    id: 'p05',
  ...
  {
    id: 'p14',
    name: 'Sportinė striukė, grafito pilka',
    season: 'pavasaris-ruduo',
    images: ['jacket-56.jpg','jacket-57.jpg'],
    tiers: [{min:5,max:10,price:51},{min:11,max:20,price:36},{min:21,max:null,price:33}],
    desc: 'Įprasto ilgio grafito pilka striukė su reguliuojamu gobtuvu ir krūtinės kišene. Tinka kasdieniam biuro ir lauko naudojimui.'
  },
  {
    id: 'p11',
